...
| STEP | 機能 | 状態 |
| --- | --- | --- |
| F001 | プロジェクト初期化 | ✅ passing |
| F002 | 気象 API 連携と記録フォーム | ✅ passing |
| F003 | ダッシュボード (相関分析) | ✅ passing |
| F004 | 明日の予測機能 | ✅ passing |
| F005 | SEO 記事システム + PWA | ✅ passing |
| F006 | 必須ページ / 広告準備 | ✅ passing |
| F007 | デプロイ前チェック | ✅ passing |
