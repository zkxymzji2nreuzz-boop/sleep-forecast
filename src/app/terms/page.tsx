...
export default function TermsPage() {
  return (
    <div className="container mx-auto max-w-[720px] px-5 pb-20 pt-10">
      ...
      <p className="text-sm text-muted-foreground mb-8">最終更新日：2026年4月26日</p>

      <section className="mb-8">
        <h2 className="text-lg font-bold border-b border-border pb-2 mb-4">第1条（適用）</h2>
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold border-b border-border pb-2 mb-4">第2条（医療免責）</h2>
        <ul className="text-sm text-muted-foreground space-y-3">
          <li>1. 本サービスは、気象データと睡眠品質の相関を参考情報として提供するものであり、<strong className="text-foreground">医療行為、医学的な診断、治療、またはそれらの代替を目的としたものではありません。</strong></li>
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold border-b border-border pb-2 mb-4">第3条（免責事項）</h2>
        <ul className="text-sm text-muted-foreground space-y-3">
          <li>1. 運営者は、本サービスの内容の正確性、完全性、安全性、適時性等について、いかなる保証も行いません。</li>
          <li>2. <strong className="text-foreground">Webアプリ</strong>：本サービスは、ブラウザの localStorage にデータを保存します。ブラウザのデータ消去、デバイスの故障等によるデータの消失について、運営者は一切の責任を負いません。</li>
          <li>3. <strong className="text-foreground">iOSアプリ</strong>：体調ログ・睡眠ログ等のデータはデバイス内の AsyncStorage に保存されます。アプリの削除、デバイスの故障等によるデータの消失について、運営者は一切の責任を負いません。</li>
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold border-b border-border pb-2 mb-4">第5条（知的財産権）</h2>
        <p className="text-sm text-muted-foreground">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold border-b border-border pb-2 mb-4">第6条（規約変更）</h2>
        <p className="text-sm text-muted-foreground">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-bold border-b border-border pb-2 mb-4">第7条（準拠法・管轄）</h2>
        <p className="text-sm text-muted-foreground">
