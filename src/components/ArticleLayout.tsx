...
export function ArticleLayout({ article, related, dataBadge }: Props) {
  return (
    <article className="container mx-auto max-w-[680px] px-5 pb-20 pt-10 sm:pt-14">
          ...
          <ol className="space-y-2 text-sm">
            {article.toc.map((item, index) => (
              <li key={item.id} className="leading-relaxed">
                ...
                >
                  <span className="mt-0.5 text-[11px] tabular-nums text-primary/60">
      ...
      {(() => {
        const proseClass =
          "prose dark:prose-invert prose-lg max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-headings:text-foreground prose-h2:mb-5 prose-h2:mt-14 prose-h2:border-l-[3px] prose-h2:border-primary/70 prose-h2:pl-4 prose-h2:text-2xl prose-h2:leading-snug prose-h3:mt-10 prose-h3:text-xl prose-h3:text-foreground prose-p:leading-[1.9] prose-p:text-foreground/90 prose-a:text-primary/80 prose-a:decoration-primary/40 prose-a:underline-offset-4 hover:prose-a:decoration-primary/80 prose-blockquote:rounded-r-xl prose-blockquote:border-l-primary/60 prose-blockquote:bg-primary/[0.04] prose-blockquote:py-2 prose-blockquote:pr-4 prose-blockquote:text-foreground/80 prose-strong:font-semibold prose-strong:text-foreground prose-code:rounded-md prose-code:bg-card/70 prose-code:px-1.5 prose-code:py-0.5 prose-code:text-primary/70 prose-code:before:content-none prose-code:after:content-none prose-li:my-1 prose-li:leading-[1.85] prose-li:text-foreground/90 prose-th:text-slate-800 dark:prose-th:text-slate-100 prose-th:font-semibold prose-th:border-slate-300 dark:prose-th:border-slate-600 prose-td:text-slate-700 dark:prose-td:text-slate-200 prose-td:border-slate-200 dark:prose-td:border-slate-700/70 prose-thead:border-b-2 prose-thead:border-slate-300 dark:prose-thead:border-slate-600";
